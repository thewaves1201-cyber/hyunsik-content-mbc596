...
- Generated context root hint: `/Users/jun/The Waves Inc. Dropbox/The Waves/06 프로덕션 및 제작프로젝트/2026/02 MBC 플러스/100 소디엑_현식_콘텐츠`. If this path exists, run workspace commands from there.
